describe('color helpers', function() {
    ...
    describe('hslToHexColor', function() {
        it('should convert white', function() {
            var hsl = [0,0,100];
           expect(ColorHelper.hslToHexColor.apply(null,hsl)).toEqual('#ffffff');
        });
        it('should convert black', function() {
            var hsl = [0,0,0];
           expect(ColorHelper.hslToHexColor.apply(null,hsl).toHexColor()).toEqual('#000000');
        });
        it('should convert blue', function() {
           expect(ColorHelper.hslToHexColor(240, 100, 50).toHexColor()).toEqual('#0000ff');
        });
        it('should convert red', function() {
           expect(ColorHelper.hslToHexColor(0, 100, 25).toHexColor()).toMatch(/#800000/);
        });
    });
    ...
    describe('saturate', function() {
        ...
        it('should saturate(hsl(120, 30%, 90%), 20%)', function() {
           expect(ColorHelper.hslToHexColor(120, 30, 90).saturate(20)).toEqual('#d9f2d9')
        });
        ...
        it('should desaturate(hsl(120, 30%, 90%), 20%) => hsl(120, 10%, 90%)', function() {
           expect(ColorHelper.hslToHexColor(120, 30, 90).saturate(-20)).toEqual('#e3e8e3')
        });
